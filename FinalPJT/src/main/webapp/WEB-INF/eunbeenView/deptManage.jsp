          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div style="float:left;">
               <h4 class=""><span style="font-size:40px;font-weight:bold;">조직도 관리</span> 부서를 추가하고, 수정, 삭제할 수 있습니다</h4>
              </div>
              <div style="margin-left:1000px;">
                <button style="width:15%;height:40px;font-size:20px;" data-toggle="modal" data-target="#exampleModalCenter" id="insDept" type="button" class="btn btn-primary">부서 추가</button>
		      </div>
            </div><br>
                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th style="font-size:20px;font-weight:bold;text-align:center;">구성원 수</th>
			  ...
			  <div class="modal-dialog modal-dialog-centered" role="document">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h5 class="modal-title" id="modalTitle">부서추가</h5>
			      ...
			      <div class="modal-body">
					...
					<input type="hidden" name="proc"/>
				     <div class="row">
				      <div class="col">
				        <input type="text" class="form-control" placeholder="부서명을 입력하세요" name="dname">
				      </div>
				     </div>
				     <div class="row">
				      <div class="col">
				      	<select name="parentdept">
					    	<option value="">상위부서명선택</option>
					    	<c:forEach var="parentDept" items="${parentDeptCom}">
					    	<option>${parentDept}</option>
					    	</c:forEach>
					    </select>
				      </div>
				     </div>
				     <div class="row">
				      <div class="col">
				        <input type="text" class="form-control" placeholder="부서코드번호을 입력하세요" name="deptid">
				      </div>
				     </div>

      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <br><br><br>
             <h4 class=""><span style="font-size:35px;font-weight:bold;">기능 권한 설정</span> 기능 사용 권한 및 관리기능을 설정할 수 있습니다.</h4>
              ...
              <div class="card">
                <div style="font-size:20px;font-weight:bold;" class="table-responsive text-nowrap">
                  <table class="table">
                    <thead>
                      <tr>
                        <th style="font-size:20px;font-weight:bold;text-align:center;">기능</th>
                        <th style="font-size:20px;font-weight:bold;text-align:center;">권한</th>
                        <th style="font-size:20px;font-weight:bold;text-align:center;">설정</th>
                      </tr>
                    </thead>
                    <tbody class="table-border-bottom-0">
                      <tr>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>멤버 초대</strong></td>
                        <td>
                        	<select>
                        		<option>Admin</option>
                        		<option>CEO</option>
                        ...
                        <td><button type="button" class="btn btn-primary">설정</button></td>
                      </tr>
                      <tr>
                        <td><i class="fab fa-react fa-lg text-info me-3"></i> <strong>업무 계정 추가/삭제</strong></td>
                        <td>
                        	<select>
                        		<option>Admin</option>
                        		<option>CEO</option>
                      ...
                      <tr>
                        <td><i class="fab fa-vuejs fa-lg text-success me-3"></i> <strong>프로젝트 추가</strong></td>
                        <td>
                        	<select>
                        		<option>Admin</option>
                        		<option>CEO</option>
                      ...
                      <tr>
                        <td>
                          <i class="fab fa-bootstrap fa-lg text-primary me-3"></i> <strong>커뮤니티 공지사항 추가</strong>
                        </td>
                        <td>
                        	<select>
                        		<option>Admin</option>
                      ...
                      <tr>
                        <td>
                          <i class="fab fa-bootstrap fa-lg text-primary me-3"></i> <strong>공개 프로젝트 보기</strong>
                        </td>
                        <td>
                        	<select>
                        		<option>Admin</option>
                      ...
                      <tr>
                        <td>
                          <i class="fab fa-bootstrap fa-lg text-primary me-3"></i> <strong>비공개 프로젝트 보기</strong>
                        </td>
                        <td>
                        	<select>
                        		<option>Admin</option>

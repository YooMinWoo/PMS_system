	...
	$(document).ready(function(){
		...
		$("#regBtn").click(function(){
			if(confirm("등록 하시겠습니까?")){
				console.log("제목 : "+$("[name=subject]").val())
				console.log("날짜1 : "+$("[name=reg]").val())
				console.log("날짜2 : "+$("[name=end]").val())
				console.log("날짜2 : "+$("[name=prjno]").val())
				console.log("날짜2 : "+$("[name=id]").val())
				console.log("날짜2 : "+$("[name=cont]").val())
				if($("[name=subject]").val()==""){
					alert("제목을 입력하세요.")
					$("[name=subject]").focus()
					return
				...
				/*
				$("[name=regdte]").val($("[name=reg]").val())
				$("[name=enddte]").val($("[name=end]").val())
				console.log("날짜1 : "+$("[name=regdte]").val())
				console.log("날짜2 : "+$("[name=enddte]").val())
				*/
				$("form").submit();
				if(msg!=""){
					alert(msg)
